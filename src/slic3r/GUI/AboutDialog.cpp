...
wxString CopyrightsDialog::get_html_text()
{
    ...
    wxString text = wxString::Format(
        ...
        _L("Dremel 3D Slicer is based on PrusaSlicer and BambuStudio"),
        _L("Libraries"),
...
// #endif
    ...
    text_list.push_back(_L("Dremel 3D Slicer is based on BambuStudio, PrusaSlicer, and SuperSlicer."));
