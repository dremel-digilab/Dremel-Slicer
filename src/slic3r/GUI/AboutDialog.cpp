    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize)
{
    ...
    this->logo = ScalableBitmap(this, Slic3r::var("Dremel3DSlicer_192px.png"), wxBITMAP_TYPE_PNG);
...
wxString CopyrightsDialog::get_html_text()
{
    ...
    wxString text = wxString::Format(
        ...
        _L("License"),
        _L("Dremel 3D Slicer is licensed under "),
        "https://www.gnu.org/licenses/agpl-3.0.html",_L("GNU Affero General Public License, version 3"),
        _L("Dremel 3D Slicer is based on OrcaSlicer"),
        _L("Libraries"),
        ...
        wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE)
{
    ...
    // logo
    m_logo_bitmap = ScalableBitmap(this, "Dremel3DSlicer_about", 250);
    ...
    // version
    {
        ...
        auto          version_string = std::string(SoftFever_VERSION); // _L("Dremel 3D Slicer ") + " " + std::string(SoftFever_VERSION);
...
// #endif
    ...
    text_list.push_back(_L("Dremel 3D Slicer is based on OrcaSlicer"));
    text_list.push_back(_L("OrcaSlicer is based on BambuStudio, which is originally based on PrusaSlicer by PrusaResearch."));
    ...
    wxStaticText *html_text = new wxStaticText(this, wxID_ANY, "Copyright(C) 2025 3PI Tech solutions", wxDefaultPosition, wxDefaultSize);
    ...
    m_html = new wxHtmlWindow(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHW_SCROLLBAR_NEVER /*NEVER*/);
      {
          ...
          const auto text = from_u8(
              ...
              "<html>"
              "<body>"
              "<p style=\"text-align:left\"><a style=\"color:#009789\" href=\"https://github.com/dremel-digilab/Dremel-Slicer\">https://github.com/dremel-digilab/Dremel-Slicer</ a></p>"
              "</body>"
              "</html>")
            ).str());
          m_html->SetPage(text);
