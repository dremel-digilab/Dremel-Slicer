...
const char *PresetBundle::ORCA_DEFAULT_BUNDLE = "Dremel";
const char *PresetBundle::ORCA_DEFAULT_PRINTER_MODEL = "Dremel 3D50 0.4 nozzle";
const char *PresetBundle::ORCA_DEFAULT_PRINTER_VARIANT = "0.4";
const char *PresetBundle::ORCA_DEFAULT_FILAMENT = "Dremel PLA @3D50";
